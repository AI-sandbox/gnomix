...
# @pytest.mark.parametrize("array, window_size, stride, expected_output", [
#     (
#         np.array([
#             [11,12,13],
#             [21,22,23]
...
#     )
# ])
# def test_get_sliding_window_from_2D_array(
#     array: ArrayLike,
#     window_size: int,
#     stride: int,
#     expected_output: ArrayLike
# ) -> None:
#     output = Base.get_sliding_window_from_2D_array(
#         array=array,
#         window_size=window_size,
#         stride=stride
#     )
#     print(output.shape)
#     print(output)
#     print("First window:", output[0])
#     print("Second window:", output[1])
#     assert np.all(output == expected_output)
