...
from gnomix.model.smooth.utils import slide_window

from xgboost import XGBClassifier
from gnomix.model.smooth.crf import CRF
...
class CNN_Smoother(Smoother):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from gnomix.model.smooth.cnn import CNN # This is to avoid requiring the installation of pytorch
